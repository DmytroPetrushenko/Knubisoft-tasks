...
import com.knubisoft.base.validation.dao.impl.UserDaoImpl;
import com.knubisoft.base.validation.util.StringUtil;
        ...
        for (Field field : fields) {
            ...
            for (Annotation annotation : annotationList) {
                ...
                if (annotation.annotationType() == PrimaryKey.class) {
                    ...
                    if (userDao.getAllId().contains(id) && primaryKeyAnnotation.isPrimary()) {
                ...
                if (annotation.annotationType() == ReferClass.class) {
                    ...
                    Long id;
                    try {
                        Class<?> daoClass = Class.forName(UserDao.class.getPackageName() + "."
